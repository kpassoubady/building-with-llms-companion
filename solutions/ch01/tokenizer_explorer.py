...
Run: python solutions/ch01/tokenizer_explorer.py  (from the repo root)
"""
...
def main():
    ...
    # Answer: non-Latin scripts (Tamil, Japanese) use the most tokens per character
    # because each character or syllable maps to a separate token, unlike English
    # where common words are often a single token.
