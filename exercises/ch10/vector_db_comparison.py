...
Run: python exercises/ch10/vector_db_comparison.py  (from the repo root)
"""
...
def build_chroma_collection(documents):
    ...
    #   Chroma will auto-embed using its default model, or you can pass embeddings
    #   explicitly if you want to use the same model as FAISS for a fair comparison.
    # Hint (using Chroma's built-in embedding - easiest path):
    ...
    # return collection
    #
    # Hint (passing your own vectors for a consistent embedding model):
