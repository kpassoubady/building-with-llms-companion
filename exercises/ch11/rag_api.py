...
Run (server):
    uvicorn exercises.ch11.rag_api:app --reload  (from the repo root)

Or directly:
    python exercises/ch11/rag_api.py  (from the repo root)
"""
...
if __name__ == "__main__":
    import uvicorn
    uvicorn.run("exercises.ch11.rag_api:app", host="0.0.0.0", port=8000, reload=True)


# Expected interaction (illustrative):
# $ uvicorn exercises.ch11.rag_api:app --reload
